...
$pembeli = query("SELECT max(id_pembeli) as kode_terbesar FROM pembeli")[0];
$id_pembeli = $pembeli["kode_terbesar"];
$urutan = (int) substr($id_pembeli, 1, 4);

$urutan++;
$huruf = "P";
$id_pembeli = $huruf . sprintf("%04s", $urutan);
...
<body class="app sidebar-mini rtl">
  ...
  <main class="app-content">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="tile">
          <h3 class="tile-title">Tambah Data Pembeli</h3>
          <div class="tile-body">
            <form action="" method="post">
              <!-- <div class="form-group"> -->
              <!-- <label class="control-label" for="id_pembeli">Id Pembeli</label> -->
              <input class="form-control" type="hidden" placeholder="Masukan id pembeli" id="id_pembeli" name="id_pembeli" value="<?= $id_pembeli; ?>" required>
              ...
              <div class="form-group">
                ...
                <input class="form-control" type="text" placeholder="Masukan nama pembeli" id="nama_pembeli" name="nama_pembeli" required>
              </div>
              <div class="form-group">
                <label class="control-label" for="telp_pembeli">Telp Pembeli</label>
                <input class="form-control" type="telp" placeholder="Masukan telp pembeli" id="telp_pembeli" name="telp_pembeli" required>
              </div>
              <div class="form-group">
                <label class="control-label" for="email_pembeli">Email Pembeli</label>
                <input class="form-control" type="email" placeholder="Masukan email pembeli" id="email_pembeli" name="email_pembeli" required>
              </div>
              <div class="form-group">
                <label class="control-label" for="alamat_pembeli">Alamat Pembeli</label>
                <input class="form-control" type="text" placeholder="Masukan alamat pembeli" id="alamat_pembeli" name="alamat_pembeli" required>
              </div>
          </div>
          <div class="tile-footer">
            <button class="btn btn-primary" type="submit" name="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Tambah</button>&nbsp;&nbsp;&nbsp;
            <a class="btn btn-secondary" href="pembeli.php"><i class="fa fa-fw fa-lg fa-times-circle"></i>Batal</a>
          </div>
          </form>
        </div>
      </div>
