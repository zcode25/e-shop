...
$kategori = query("SELECT max(kode_kategori) as kode_terbesar FROM kategori")[0];
$kode_kategori = $kategori["kode_terbesar"];
$urutan = (int) substr($kode_kategori, 1, 4);

$urutan++;
$huruf = "Q";
$kode_kategori = $huruf . sprintf("%04s", $urutan);
                ...
                <div class="tile">
                    ...
                    <div class="tile-body">
                        <form action="" method="post">
                            ...
                            <input class="form-control" type="hidden" placeholder="Masukan kode kategori" id="kode_kategori" name="kode_kategori" value="<?= $kode_kategori; ?>" required>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" placeholder="Masukan nama kategori" id="nama_kategori" name="nama_kategori" required>
                            </div>
                    </div>
