...
<body class="app sidebar-mini rtl">
  ...
  <main class="app-content">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="tile">
          <h3 class="tile-title">Ubah Data Pembeli</h3>
          <div class="tile-body">
            <form action="" method="post">
              <!-- <div class="form-group"> -->
              <!-- <label class="control-label" for="id_pembeli">Id Pembeli</label> -->
              <input class="form-control" type="hidden" placeholder="Masukan id pembeli" id="id_pembeli" name="id_pembeli" value="<?= $pembeli['id_pembeli']; ?>" required readonly>
              <!-- </div> -->
              <div class="form-group">
                <label class="control-label" for="nama_pembeli">Nama Pembeli</label>
                <input class="form-control" type="text" placeholder="Masukan nama pembeli" id="nama_pembeli" name="nama_pembeli" value="<?= $pembeli['nama_pembeli']; ?>" required>
              </div>
              <div class="form-group">
                <label class="control-label" for="telp_pembeli">Telp Pembeli</label>
                <input class="form-control" type="telp" placeholder="Masukan telp pembeli" id="telp_pembeli" name="telp_pembeli" value="<?= $pembeli['telp_pembeli']; ?>" required>
              </div>
              <div class="form-group">
                <label class="control-label" for="email_pembeli">Email Pembeli</label>
                <input class="form-control" type="email" placeholder="Masukan email pembeli" id="email_pembeli" name="email_pembeli" value="<?= $pembeli['email_pembeli']; ?>" required>
              </div>
              <div class="form-group">
                <label class="control-label" for="alamat_pembeli">Alamat Pembeli</label>
                <input class="form-control" type="text" placeholder="Masukan alamat pembeli" id="alamat_pembeli" name="alamat_pembeli" value="<?= $pembeli['alamat_pembeli']; ?>" required>
              </div>
          </div>
