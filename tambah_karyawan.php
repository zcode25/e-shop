...
$urutan = (int) substr($id_karyawan, 1, 4);
...
<body class="app sidebar-mini rtl">
  ...
  <main class="app-content">
    <div class="app-title">
      <div>
        <h1><i class="fa fa-briefcase"></i> Karyawan</h1>
      </div>
    </div>
    <div class="row">
      <div class="col-md-12">
        <div class="tile">
          <h3 class="tile-title">Tambah Data Karyawan</h3>
          <div class="tile-body">
            <form action="" method="post">
              <!-- <div class="form-group"> -->
              <!-- <label class="control-label" for="id_karyawan">Kode Karyawan</label> -->
              <input class="form-control" type="hidden" placeholder="Masukan kode karyawan" id="id_karyawan" name="id_karyawan" value="<?= $id_karyawan; ?>" required>
              ...
              <div class="form-group">
                ...
                <input class="form-control" type="text" placeholder="Masukan nama karyawan" id="nama_karyawan" name="nama_karyawan" required>
              </div>
              <div class="form-group">
                <label class="control-label" for="telp_karyawan">Telp Karyawan</label>
                <input class="form-control" type="telp" placeholder="Masukan telp karyawan" id="telp_karyawan" name="telp_karyawan" required>
              </div>
              <div class="form-group">
                <label class="control-label" for="email_karyawan">Email Karyawan</label>
                <input class="form-control" type="email" placeholder="Masukan email karyawan" id="email_karyawan" name="email_karyawan" required>
              </div>
              <div class="form-group">
                <label class="control-label" for="alamat_karyawan">Alamat Karyawan</label>
                <input class="form-control" type="text" placeholder="Masukan alamat karyawan" id="alamat_karyawan" name="alamat_karyawan" required>
              </div>
              <div class="form-group">
