...
if (isset($_POST["cari"])) {
    $suppliers = cari_supplier($_POST["keyword"], $kode);
}
...
<body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="tile">
                    <h3 class="tile-title">Data Supplier</h3>
                    <div class="col">
                        <a href="tambah_supplier.php" class="btn btn-primary float-right mb-3">Tambah Supplier</a>
                    </div>
                            ...
                            <tbody>
                                <?php foreach ($suppliers as $supplier) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="ubah_supplier.php?kode=<?= $supplier["kode_supplier"] ?>" class="badge badge-primary" title="ubah"><i class="fa fa-pencil"></i></a>
                                            <a href="hapus_supplier.php?kode=<?= $supplier["kode_supplier"] ?>" class="badge badge-danger" title="hapus" onclick=" return confirm ('yakin ?');"><i class="fa fa-trash-o"></i></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
