...
$barang = query("SELECT max(kode_barang) as kode_terbesar FROM barang")[0];
$kode_barang = $barang["kode_terbesar"];
        ...
        <div class="tile">
          ...
          <div class="tile-body">
            <form action="" method="post">
              ...
              <input class="form-control" type="hidden" placeholder="Masukan kode barang" id="kode_barang" name="kode_barang" value="<?= $kode_barang; ?>" required>
              ...
              <div class="form-group">
                ...
                <input class="form-control" type="text" placeholder="Masukan nama barang" id="nama_barang" name="nama_barang" required>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input class="form-control" type="number" placeholder="Masukan harga beli" id="harga_beli" name="harga_beli" required>
              </div>
              <div class="form-group">
                <label class="control-label" for="harga_jual">Harga Jual</label>
                <input class="form-control" type="number" placeholder="Masukan harga jual" id="harga_jual" name="harga_jual" required>
              </div>
              <div class="form-group">
                <label class="control-label" for="stok">Stok</label>
                <input class="form-control" type="number" placeholder="Masukan stok" id="stok" name="stok" required>
              </div>
              <div class="form-group">
