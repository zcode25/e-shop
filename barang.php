...
$kategoris = query("SELECT * FROM kategori WHERE kode_bisnis = '$kode'");
$barangs = query("SELECT * FROM barang JOIN supplier USING(kode_supplier) JOIN kategori USING(kode_kategori) WHERE barang.kode_bisnis = '$kode' ORDER BY kode_barang");
// $barangs = query("SELECT * FROM barang JOIN supplier USING(kode_supplier) WHERE barang.kode_bisnis = 'B1'");
...
if (isset($_POST["cari"])) {
    $barangs = cari_barang($_POST["keyword"], $kode);
}

if (isset($_POST["carik"])) {
    $kategoris = cari_kategori($_POST["keywordk"], $kode);
}
...
<body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="tile">
                    <h3 class="tile-title">Data Kategori</h3>
                    <div class="col">
                        <a href="tambah_kategori.php" class="btn btn-primary float-right mb-3">Tambah Kategori</a>
                    </div>
                    <div class="col-md-4 float-right">
                        <form action="" method="post">
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" placeholder="Cari data ..." id="keywordk" id="keywordk" name="keywordk" autocomplete="off">
                                <div class="input-group-append">
                                    <button class="btn btn-outline-primary" type="submit" id="carik" name="carik">Cari</button>
                                </div>
                            </div>
                        </form>
                    </div>
                            ...
                            <tbody>
                                <?php foreach ($kategoris as $kategori) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="ubah_kategori.php?kode=<?= $kategori["kode_kategori"] ?>" class="badge badge-primary" title="ubah"><i class="fa fa-pencil"></i></a>
                                            <a href="hapus_kategori.php?kode=<?= $kategori["kode_kategori"] ?>" class="badge badge-danger" title="hapus" onclick=" return confirm ('yakin ?');"><i class="fa fa-trash-o"></i></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="tile">
                    ...
                    <div class="col">
                        <a href="tambah_barang.php" class="btn btn-primary float-right mb-3">Tambah Barang</a>
                    </div>
                    <div class="col-md-4 float-right">
                        <form action="" method="post">
                            <div class="input-group mb-3">
                            ...
                            <tbody>
                                <?php foreach ($barangs as $barang) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="ubah_barang.php?kode=<?= $barang["kode_barang"] ?>" class="badge badge-primary" title="ubah"><i class="fa fa-pencil"></i></a>
                                            <a href="hapus_barang.php?kode=<?= $barang["kode_barang"] ?>" class="badge badge-danger" title="hapus" onclick=" return confirm ('yakin ?');"><i class="fa fa-trash-o"></i></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
