...
$kode = $_GET["kode"];
$kategori = query("SELECT * FROM kategori WHERE kode_kategori= '$kode' ")[0];
...
<body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-archive"></i> Kategori</h1>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="tile">
                    ...
                    <div class="tile-body">
                        <form action="" method="post">
                            ...
                            <input class="form-control" type="hidden" placeholder="Masukan kode kategori" id="kode_kategori" name="kode_kategori" value="<?= $kategori['kode_kategori']; ?>" required>
                            <!-- <input class="form-control" type="hidden" id="kode_bisnis" name="kode_bisnis" value="" required> -->
                            <!-- </div> -->
                            <div class="form-group">
                                <label class="control-label" for="nama_kategori">Nama Kategori</label>
                                <input class="form-control" type="text" placeholder="Masukan nama kategori" id="nama_kategori" name="nama_kategori" value="<?= $kategori['nama_kategori'] ?>" required>
                            </div>
                    </div>
