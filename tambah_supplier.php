...
$supplier = query("SELECT max(kode_supplier) as kode_terbesar FROM supplier")[0];
$kode_supplier = $supplier["kode_terbesar"];
$urutan = (int) substr($kode_supplier, 1, 4);

$urutan++;
$huruf = "S";
$kode_supplier = $huruf . sprintf("%04s", $urutan);

// var_dump($kode_supplier);
// exit();
...
<body class="app sidebar-mini rtl">
  ...
  <main class="app-content">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="tile">
          <h3 class="tile-title">Tambah Data Supplier</h3>
          <div class="tile-body">
            <form action="" method="post">
              <!-- <div class="form-group"> -->
              <!-- <label class="control-label" for="kode_supplier">Kode Supplier</label> -->
              <input class="form-control" type="hidden" placeholder="Masukan kode supplier" id="kode_supplier" name="kode_supplier" value="<?= $kode_supplier ?>" required>
              ...
              <div class="form-group">
                ...
                <input class="form-control" type="text" placeholder="Masukan nama supplier" id="nama_supplier" name="nama_supplier" required>
              </div>
              <div class="form-group">
                <label class="control-label" for="telp_supplier">Telp Supplier</label>
                <input class="form-control" type="telp" placeholder="Masukan telp supplier" id="telp_supplier" name="telp_supplier" required>
              </div>
              <div class="form-group">
                <label class="control-label" for="email_supplier">Email Supplier</label>
                <input class="form-control" type="email" placeholder="Masukan email supplier" id="email_supplier" name="email_supplier" required>
              </div>
              <div class="form-group">
                <label class="control-label" for="alamat_supplier">Alamat Supplier</label>
                <input class="form-control" type="text" placeholder="Masukan alamat supplier" id="alamat_supplier" name="alamat_supplier" required>
              </div>
          </div>
